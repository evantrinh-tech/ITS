...
# Chạy: .\scripts\setup_tensorflow.ps1
...
pip install numpy pandas scikit-learn mlflow fastapi uvicorn pywavelets kafka-python python-dotenv pyyaml python-json-logger sqlalchemy psycopg2-binary opencv-python pillow streamlit
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "Để chạy hệ thống:" -ForegroundColor Cyan
    Write-Host "  .\scripts\he_thong.bat" -ForegroundColor Yellow
} else {
    Write-Host ""
